...
public abstract class CompositeShape extends Shape {
	 ...
	 * @return true if the shape was present and was removed, false if the shape was
	 *         not present
	 */
	...
	public List<Shape> getShapesByType(ShapeType shapeType) {
		List<Shape> listByType = new ArrayList<Shape>();

		for (Shape s : this.shapes) {
			if (s.getType().equals(shapeType))
				listByType.add(s);
		}
	...
	public List<Shape> getLeafShapes() {
		List<Shape> listByLeaf = new ArrayList<Shape>();
