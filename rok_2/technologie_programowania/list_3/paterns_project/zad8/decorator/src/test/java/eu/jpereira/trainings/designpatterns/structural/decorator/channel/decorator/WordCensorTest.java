...
public class WordCensorTest extends AbstractSocialChanneldDecoratorTest {
	...
	public void testCensor() {
		...
		SocialChannel channel = builder.with(new WordCensor("Izet")).getDecoratedChannel(props);

		channel.deliverMessage("Izet is real department");

		TestSpySocialChannel spyChannel = (TestSpySocialChannel) builder.buildChannel(props);
		assertEquals("### is real department", spyChannel.lastMessagePublished());
	}
}