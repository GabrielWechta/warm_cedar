...
public class ReportAssemblerTest {
	...
	public void testAssembleJSONReportBody() {
		...
		ReportBuilder jsonReportBuilder = new JSONReportBuilder();
		jsonReportBuilder.setSaleEntry(createDummySaleEntry());
	...
	public void testAssembleXMLReportBody() {
		...
		ReportBuilder xmlReportBuidler = new XMLReportBuilder();
		xmlReportBuidler.setSaleEntry(createDummySaleEntry());
		Report report = xmlReportBuidler.getReport();
	...
	public void testAssembleHTMLReportBody() {
		...
		ReportBuilder HTMLReportBuidler = new HTMLReportBuilder();
		HTMLReportBuidler.setSaleEntry(createDummySaleEntry());
		Report report = HTMLReportBuidler.getReport();
