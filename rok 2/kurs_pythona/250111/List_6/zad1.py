# Ostatnia kolumna z samymi zerami jest niezbędna przy mnożeniu macierzy. Musimy uzupełnić macierz inputu
# elementem neutralnym aby jej rozmiar nadawał się do mnożenia z macierzą weights1 oraz delta1.
