...
public class SimpleVehicleBuilderTest {
	...
	@Test
	public void testTimesOne() throws NeedToPackLastVehicleException, VehicleDoesNotHavePartsException,
			CouldNotCloneLastObjectException, CannotHaveZeroPartsException {
		SimpleVehicleBuilder builder = new SimpleVehicleBuilder();
	...
	public void testTimesZero() throws NeedToPackLastVehicleException, VehicleDoesNotHavePartsException,
			CouldNotCloneLastObjectException, CannotHaveZeroPartsException {
		SimpleVehicleBuilder builder = new SimpleVehicleBuilder();
	...
	@Test
	public void testTimesMany() throws NeedToPackLastVehicleException, VehicleDoesNotHavePartsException,
			CouldNotCloneLastObjectException, CannotHaveZeroPartsException {
		SimpleVehicleBuilder builder = new SimpleVehicleBuilder();
	...
	@Test
	public void testTimesManyDifferent() throws NeedToPackLastVehicleException, VehicleDoesNotHavePartsException,
			CouldNotCloneLastObjectException, CannotHaveZeroPartsException {
		SimpleVehicleBuilder builder = new SimpleVehicleBuilder();
		Vehicle vehicle = builder.createVehicle().with(new Tire()).times(10).with(new Window()).times(2)
				.with(new Shell()).packIt();
