...
public class SimpleDoorController implements DoorController {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see eu.jpereira.trainings.designpatterns.structural.adapter.DoorController
	 * #addDoor (eu.jpereira.trainings.designpatterns.structural.adapter.model.Door)
	 */
	@Override
	 ...
	 * 
	 * @see eu.jpereira.trainings.designpatterns.structural.adapter.DoorController#
	 * closeDoor(eu.jpereira.trainings.designpatterns.structural.adapter.model.Door)
	 */
	@Override
